            ...
            >
                <div className="max-w-7xl mx-auto flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs leading-tight" style={{ color: "var(--text-subtle)" }}>
                            <MathText text={t("appSubtitle")} />
                        </p>
                    </div>
                        ...
                        <div className="relative">
                            ...
                            {menuOpen && (
                                ...
                                >
                                    ...
                                    <div
                                        className="border-t pt-2 flex flex-col"
                        ...
                        {stats.piEstimate !== null ? (
                            <>
                                <span className="text-2xl font-mono font-bold text-violet-500 flex items-center gap-1">
                                    <MathComponent
                                        math={String.raw`\hat{\pi} \approx ${stats.piEstimate.toFixed(5)}`}
                                    />
                                </span>
                                <span

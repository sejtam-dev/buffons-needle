    ...
    return createPortal(
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4" aria-modal="true" role="dialog">
            ...
            >
                ...
                {/* Body */}
                <div
                    className="px-6 py-5 space-y-1 text-sm leading-relaxed max-h-[75vh] overflow-y-auto"
                    style={{ color: "var(--text-muted)" }}
                >
                    <p className="text-justify">
                        <MathText text={t("infoIntro")} />
                    </p>

                    <SectionTitle>
                        <MathText text={t("infoSetupTitle")} />
                    </SectionTitle>
                    <p className="text-justify">
                        <MathText text={t("infoSetup")} />
                    </p>
                    <p className="text-xs mt-1 text-justify" style={{ color: "var(--text-subtle)" }}>
                        <MathText text={t("infoConstraint")} />
                    </p>

                    <SectionTitle>
                        <MathText text={t("infoConditionTitle")} />
                    </SectionTitle>
                    <p className="text-justify">
                        <MathText text={t("infoCondition")} />
                    </p>
                    ...
                    <SectionTitle>
                        <MathText text={t("infoProbTitle")} />
                    </SectionTitle>
                    <p className="text-justify">
                        <MathText text={t("infoProb")} />
                    </p>
                    <div className="my-3 py-3 rounded-xl text-center" style={{ background: "var(--bg-panel-alt)" }}>
                    ...
                    <SectionTitle>
                        <MathText text={t("infoEstimateTitle")} />
                    </SectionTitle>
                    <p className="text-justify">
                        <MathText text={t("infoEstimate")} />
                    </p>
                    <div className="my-3 py-3 rounded-xl text-center" style={{ background: "var(--bg-panel-alt)" }}>
                        <Math block math={String.raw`\hat{\pi} \approx \frac{2l \cdot n}{d \cdot c}`} />
                    </div>
                    <p className="text-justify">
                        <MathText text={t("infoConverge")} />
                    </p>

                    <SectionTitle>
                        <MathText text={t("infoInteractTitle")} />
                    </SectionTitle>
                    <p className="text-justify">
                        <MathText text={t("infoInteract")} />
                    </p>
                </div>
            </div>
        </div>,
